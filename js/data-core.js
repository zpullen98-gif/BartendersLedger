...
const KNOWLEDGE = [
  ...
  { q:"Who published the first cocktail book, and when?",
    ...
    a:1, explain:"Jerry Thomas, Bar-Tender's Guide, 1862 — the first time anyone wrote the specs down. Craddock's Savoy Cocktail Book is the tempting answer because it's the more famous volume, but 1930 puts it 68 years later, codifying a canon Thomas had already started." },
  { q:"The flamed orange peel is the signature move of which bartender?",
    ...
    a:2, explain:"Dale DeGroff at the Rainbow Room — the match in the guest's sightline that helped start the modern revival. Petraske is the tempting answer, since Milk & Honey is the other founding room, but his signature was the opposite of theatre: no flame, just precision." },
  { q:"The 'cocktail families' framework was popularized in The Joy of Mixology by…",
    ...
    a:1, explain:"Gary 'Gaz' Regan, The Joy of Mixology, 2003 — the template system this whole ledger is built on. Wondrich is the tempting name because he's the other great writer of that generation, but his work is history — Imbibe!, Punch — not taxonomy." },
  { q:"Jim Meehan's influential New York bar, opened in 2007, was called…",
    options:["Milk & Honey","Death & Co","PDT","The Rainbow Room"],
    a:2, explain:"PDT — 'Please Don't Tell' — entered through a phone booth in a hot dog shop, and written up in The PDT Cocktail Book. Death & Co is the tempting answer: same few blocks, same era, and Phil Ward's Oaxaca Old Fashioned came out of it. Different bar, different book." },
  ...
  { q:"How do you 'express' a citrus peel?",
    ...
    a:1, explain:"Skin-side down over the glass, one sharp snap — the oil atomizes across the surface, right where the guest's nose meets it. Charring is tempting because flaming a peel is a real move (DeGroff's Cosmo), but fire caramelizes the oil. Expressing is the plain default." },
  ...
  { q:"Ada Coleman, creator of the Hanky Panky, was head bartender at…",
    ...
    a:1, explain:"Coleman ran the Savoy's American Bar for over two decades, handing off to Harry Craddock. The Rainbow Room is the tempting one and it misses by half a century and an ocean — that's DeGroff in 1980s New York, the flamed-orange-peel man." },
];
