...
const COCKTAILS = [
  ...
  { name:"Daiquiri", tier:1, family:"Sour", spirit:"Rum",
    ...
    note:"The bartender's handshake — the truest test of balance and shake." },
  ...
  { name:"Cosmopolitan", tier:2, family:"Sour", spirit:"Vodka",
    ...
    note:"DeGroff's flamed orange peel made the modern serve famous." },
  { name:"Mai Tai", tier:2, family:"Tiki", spirit:"Rum",
    ...
    note:"Trader Vic, 1944. Blend two rums for depth." },
  ...
  { name:"Penicillin", tier:2, family:"Sour", spirit:"Whiskey",
    ...
    note:"Sam Ross, Milk & Honey, 2005 — the defining modern classic." },
  { name:"Paper Plane", tier:2, family:"Sour", spirit:"Whiskey",
    ...
    note:"Sam Ross again — the equal-parts modern sour template." },
  ...
  { name:"Corpse Reviver #2", tier:2, family:"Sour", spirit:"Gin",
    ...
    note:"Craddock's Savoy warning: four in swift succession will 'unrevive' you." },
  ...
  { name:"Hanky Panky", tier:3, family:"Spirit & Vermouth", spirit:"Gin",
    ...
    note:"Ada Coleman, head bartender of the Savoy — one of history's great bartenders." },
  ...
  { name:"Americano", tier:3, family:"Highball", spirit:"Aperitivo",
    ...
    note:"The Negroni's low-proof parent — Count Negroni asked for gin instead of soda." },
  ...
  { name:"Bramble", tier:3, family:"Sour", spirit:"Gin",
    ...
    note:"Dick Bradsell, London, 1984 — the man who also gave us the Espresso Martini." },
  ...
  { name:"Hemingway Daiquiri", tier:3, family:"Sour", spirit:"Rum",
    ...
    method:"Shake, double strain up", glass:"Coupe", garnish:"Lime wheel",
    note:"'Papa Doble' at Havana's El Floridita — no sugar, doubled rum, per the man himself." },
  { name:"White Lady", tier:3, family:"Sour", spirit:"Gin",
    ...
    note:"The gin Sidecar — Harry MacElhone's Paris classic." },
  ...
  { name:"Mint Julep", tier:3, family:"Julep & Smash", spirit:"Whiskey",
    ...
    note:"Jerry Thomas called juleps the pride of American drinks." },
  { name:"Whiskey Smash", tier:3, family:"Julep & Smash", spirit:"Whiskey",
    ...
    note:"DeGroff's revival of a Jerry Thomas original — a julep that met a sour." },
  ...
  { name:"Gold Rush", tier:4, family:"Sour", spirit:"Whiskey", spec:["2 oz bourbon","3/4 oz lemon juice","3/4 oz honey syrup"], method:"Shake, strain over a large cube", glass:"Rocks", garnish:"None", note:"T.J. Siegal at Milk & Honey — the Bee's Knees goes to Kentucky." },
  { name:"Oaxaca Old Fashioned", tier:4, family:"Old Fashioned", spirit:"Tequila", spec:["1.5 oz reposado tequila","1/2 oz mezcal","1 tsp agave nectar","2 dashes Angostura bitters"], method:"Stir over ice", glass:"Rocks, large cube", garnish:"Flamed orange peel", note:"Phil Ward's agave landmark at Death & Co." },
  { name:"Naked & Famous", tier:4, family:"Sour", spirit:"Mezcal", spec:["3/4 oz mezcal","3/4 oz yellow Chartreuse","3/4 oz Aperol","3/4 oz lime juice"], method:"Shake, double strain up", glass:"Coupe", garnish:"None", note:"Joaquín Simó — child of the Last Word and the Paper Plane." },
  { name:"Old Cuban", tier:4, family:"Sour", spirit:"Rum", spec:["1.5 oz aged rum","3/4 oz lime juice","1 oz simple syrup","6 mint leaves","2 dashes Angostura","2 oz champagne top"], method:"Shake with mint, strain, top", glass:"Coupe", garnish:"Mint leaf", note:"Audrey Saunders — a Mojito in a ballgown." },
  { name:"Tommy's Margarita", tier:4, family:"Sour", spirit:"Tequila", spec:["2 oz blanco tequila","1 oz lime juice","1/2 oz agave nectar"], method:"Shake, strain over fresh ice", glass:"Rocks", garnish:"Lime wheel", note:"Julio Bermejo, San Francisco — agave for agave, no orange liqueur." },
  { name:"Red Hook", tier:4, family:"Spirit & Vermouth", spirit:"Whiskey", spec:["2 oz rye","1/2 oz Punt e Mes","1/2 oz maraschino"], method:"Stir, strain up", glass:"Coupe", garnish:"Brandied cherry", note:"Vincenzo Errico — first of the Brooklyn-neighborhood Manhattan riffs." },
  ...
  { name:"Little Italy", tier:4, family:"Spirit & Vermouth", spirit:"Whiskey", spec:["2 oz rye","3/4 oz sweet vermouth","1/2 oz Cynar"], method:"Stir, strain up", glass:"Coupe", garnish:"Brandied cherries", note:"Audrey Saunders, Pegu Club — the artichoke Manhattan." },
  { name:"Black Manhattan", tier:4, family:"Spirit & Vermouth", spirit:"Whiskey", spec:["2 oz rye","1 oz Averna","1 dash Angostura + 1 dash orange bitters"], method:"Stir, strain up", glass:"Coupe", garnish:"Brandied cherry", note:"Todd Smith, San Francisco — amaro takes the vermouth's chair." },
  { name:"Final Ward", tier:4, family:"Sour", spirit:"Whiskey", spec:["3/4 oz rye","3/4 oz green Chartreuse","3/4 oz maraschino","3/4 oz lemon juice"], method:"Shake, double strain up", glass:"Coupe", garnish:"None", note:"Phil Ward's Last Word with rye and lemon." },
  { name:"White Negroni", tier:4, family:"Spirit & Vermouth", spirit:"Gin", spec:["1.5 oz gin","1 oz Lillet Blanc","3/4 oz Suze (gentian liqueur)"], method:"Stir over ice", glass:"Rocks, large cube", garnish:"Lemon twist", note:"Wayne Collins, 2001 — bitter goes blond." },
  { name:"Trinidad Sour", tier:4, family:"Sour", spirit:"Whiskey", spec:["1.5 oz Angostura bitters","1 oz orgeat","3/4 oz lemon juice","1/2 oz rye"], method:"Shake, double strain up", glass:"Coupe", garnish:"None", note:"Giuseppe González — the bitters ARE the base. A rite of passage." },
  { name:"Amaretto Sour", tier:4, family:"Sour", spirit:"Liqueur", spec:["1.5 oz amaretto","3/4 oz cask-proof bourbon","1 oz lemon juice","1 tsp rich simple","1 egg white"], method:"Dry shake, shake, strain over ice", glass:"Rocks", garnish:"Lemon peel + cherry", note:"Jeffrey Morgenthaler's rescue of a maligned classic." },
  ...
  { name:"Gin Basil Smash", tier:4, family:"Sour", spirit:"Gin", spec:["2 oz gin","3/4 oz lemon juice","3/4 oz simple syrup","1 handful basil leaves"], method:"Muddle basil, shake hard, double strain over ice", glass:"Rocks", garnish:"Basil sprig", note:"Jörg Meyer, Hamburg 2008 — green lightning." },
  { name:"Porn Star Martini", tier:4, family:"Sour", spirit:"Vodka", spec:["1.5 oz vanilla vodka","3/4 oz passion fruit purée","1/2 oz passion fruit liqueur","1/2 oz lime juice","1/4 oz vanilla syrup","2 oz prosecco served alongside"], method:"Shake, strain up; shot of fizz on the side", glass:"Coupe + sidecar shot", garnish:"Half passion fruit", note:"Douglas Ankrah, London — one of the world's best sellers." },
  ...
  { name:"Siesta", tier:4, family:"Sour", spirit:"Tequila", spec:["2 oz blanco tequila","1/2 oz Campari","3/4 oz lime juice","1/2 oz grapefruit juice","1/2 oz simple syrup"], method:"Shake, double strain up", glass:"Coupe", garnish:"Lime wheel", note:"Katie Stipe — a Hemingway Daiquiri gone to Jalisco." },
  { name:"Division Bell", tier:4, family:"Sour", spirit:"Mezcal", spec:["1 oz mezcal","3/4 oz Aperol","1/2 oz maraschino","3/4 oz lime juice"], method:"Shake, double strain up", glass:"Coupe", garnish:"Grapefruit twist", note:"Phil Ward, Mayahuel." },
  { name:"Kentucky Buck", tier:4, family:"Highball", spirit:"Whiskey", spec:["2 oz bourbon","1 strawberry, muddled","3/4 oz lemon juice","1/2 oz simple syrup","2 dashes Angostura","3 oz ginger beer"], method:"Muddle, shake, strain over ice, top", glass:"Highball", garnish:"Strawberry + candied ginger", note:"Erick Castro." },
  { name:"Chartreuse Swizzle", tier:4, family:"Julep & Smash", spirit:"Liqueur", spec:["1.5 oz green Chartreuse","1 oz pineapple juice","3/4 oz lime juice","1/2 oz falernum"], method:"Swizzle in crushed ice until frosted", glass:"Collins", garnish:"Nutmeg + mint", note:"Marco Dionysos — the monks go tiki." },
  { name:"Left Hand", tier:4, family:"Spirit & Vermouth", spirit:"Whiskey", spec:["1.5 oz bourbon","3/4 oz sweet vermouth","3/4 oz Campari","2 dashes chocolate bitters"], method:"Stir, strain up", glass:"Coupe", garnish:"Brandied cherry", note:"Sam Ross — a Boulevardier with a chocolate whisper." },
  { name:"Bitter Giuseppe", tier:4, family:"Spirit & Vermouth", spirit:"Aperitivo", spec:["2 oz Cynar","1 oz sweet vermouth","1/4 oz lemon juice","6 drops saline (or pinch salt)"], method:"Stir over ice", glass:"Rocks", garnish:"Lemon twist, expressed and dropped", note:"Stephen Cole, Chicago — the amaro takes the wheel." },
  { name:"Enzoni", tier:4, family:"Sour", spirit:"Gin", spec:["1 oz gin","1 oz Campari","3/4 oz lemon juice","1/2 oz simple syrup","5 green grapes, muddled"], method:"Muddle, shake, strain over ice", glass:"Rocks", garnish:"Grapes on a pick", note:"Vincenzo Errico — Negroni meets sour meets fruit stand." },
  { name:"Jasmine", tier:4, family:"Sour", spirit:"Gin", spec:["1.5 oz gin","3/4 oz lemon juice","1/4 oz Campari","1/4 oz Cointreau"], method:"Shake, double strain up", glass:"Coupe", garnish:"Lemon twist", note:"Paul Harrington, 1990s — tastes uncannily of grapefruit." },
  { name:"Fitzgerald", tier:4, family:"Sour", spirit:"Gin", spec:["2 oz gin","3/4 oz lemon juice","3/4 oz simple syrup","2 dashes Angostura"], method:"Shake, strain over ice", glass:"Rocks", garnish:"Lemon wedge", note:"Dale DeGroff's own — proof a dash of bitters transforms a gin sour." },
  { name:"Juliet & Romeo", tier:4, family:"Sour", spirit:"Gin", spec:["2 oz gin","3/4 oz lime juice","3/4 oz simple syrup","3 cucumber slices + pinch salt","5 mint leaves","3 drops rose water"], method:"Muddle, shake, double strain up", glass:"Coupe", garnish:"Mint leaf, drop of Angostura on top", note:"Toby Maloney, The Violet Hour." },
  { name:"Water Lily", tier:4, family:"Sour", spirit:"Gin", spec:["3/4 oz gin","3/4 oz crème de violette","3/4 oz Cointreau","3/4 oz lemon juice"], method:"Shake, double strain up", glass:"Coupe", garnish:"Orange twist", note:"Richard Boccato — equal-parts and lavender-hued." },
  { name:"Vieux Mot", tier:4, family:"Sour", spirit:"Gin", spec:["1.5 oz gin","3/4 oz St-Germain","3/4 oz lemon juice","1/4 oz simple syrup"], method:"Shake, double strain up", glass:"Coupe", garnish:"None", note:"Don Lee — the elderflower Last Word cousin." },
  { name:"Art of Choke", tier:4, family:"Julep & Smash", spirit:"Rum", spec:["1 oz white rum","1 oz Cynar","1/4 oz green Chartreuse","1/4 oz lime juice","1/4 oz demerara syrup","1 mint sprig"], method:"Brief stir with mint, strain over cracked ice", glass:"Rocks", garnish:"Mint sprig", note:"Kyle Davidson, The Violet Hour — bitter, herbal, unforgettable." },
  { name:"Rome with a View", tier:4, family:"Highball", spirit:"Aperitivo", spec:["1 oz Campari","1 oz dry vermouth","1 oz lime juice","1/2 oz simple syrup","2 oz soda top"], method:"Shake, strain over ice, top", glass:"Highball", garnish:"Orange wheel", note:"Michael McIlroy — the aperitivo hour gets citrus." },
  { name:"Kingston Negroni", tier:4, family:"Spirit & Vermouth", spirit:"Rum", spec:["1 oz Jamaican pot-still rum","1 oz Campari","1 oz sweet vermouth"], method:"Stir over ice", glass:"Rocks, large cube", garnish:"Orange peel", note:"Joaquín Simó — funk meets bitter." },
  { name:"Brancolada", tier:4, family:"Tiki", spirit:"Rum", spec:["1.5 oz Jamaican rum","3/4 oz Branca Menta","1.5 oz pineapple juice","3/4 oz coconut cream","1/2 oz orange juice"], method:"Whip shake, pour over crushed ice", glass:"Hurricane or rocks", garnish:"Mint + orange", note:"Jeremy Oertel — a Painkiller with a Fernet mint streak." },
  { name:"Benton's Old Fashioned", tier:4, family:"Old Fashioned", spirit:"Whiskey", spec:["2 oz bacon fat-washed bourbon","1/4 oz maple syrup","2 dashes Angostura"], method:"Stir over ice", glass:"Rocks, large cube", garnish:"Orange twist", note:"Don Lee at PDT — the fat-wash that launched a thousand infusions." },
  { name:"Conference", tier:4, family:"Old Fashioned", spirit:"Whiskey", spec:["1/2 oz each: rye, bourbon, cognac, calvados","1 tsp demerara syrup","2 dashes Angostura + 1 dash mole bitters"], method:"Stir over ice", glass:"Rocks, large cube", garnish:"Lemon + orange twists", note:"Brad Farran, Death & Co — four brown spirits, one table." },

  /* ===== TIER 5 — TIKI & TROPICAL ===== */
  { name:"Zombie", tier:5, family:"Tiki", spirit:"Rum", spec:["1.5 oz gold Puerto Rican rum","1.5 oz aged Jamaican rum","1 oz 151 demerara rum","3/4 oz lime juice","1/2 oz falernum","1/2 oz grapefruit juice","1/4 oz cinnamon syrup","1 tsp grenadine","1 dash Angostura","6 drops absinthe"], method:"Whip shake, pour over crushed ice", glass:"Tiki mug or tall", garnish:"Mint bouquet", note:"Donn Beach, 1934. Limit two per customer — house rule for a reason." },
  ...
  { name:"Navy Grog", tier:5, family:"Tiki", spirit:"Rum", spec:["1 oz dark Jamaican rum","1 oz gold demerara rum","1 oz white rum","3/4 oz lime juice","3/4 oz grapefruit juice","3/4 oz honey syrup","1 oz soda"], method:"Shake, strain over crushed ice", glass:"Double rocks", garnish:"Ice cone with straw (traditional)", note:"Donn Beach; famously Sinatra's order." },
  { name:"Three Dots and a Dash", tier:5, family:"Tiki", spirit:"Rum", spec:["1.5 oz aged rhum agricole","1/2 oz gold demerara rum","1/2 oz lime juice","1/2 oz orange juice","1/2 oz honey syrup","1/4 oz falernum","1/4 oz allspice dram","1 dash Angostura"], method:"Whip shake, crushed ice", glass:"Tall tiki", garnish:"3 cherries + pineapple frond (morse code for V)", note:"Donn Beach's WWII victory drink." },
  { name:"Saturn", tier:5, family:"Tiki", spirit:"Gin", spec:["1.25 oz gin","1/2 oz lime juice","1/2 oz passion fruit syrup","1/4 oz orgeat","1/4 oz falernum"], method:"Whip shake, crushed ice", glass:"Rocks or tiki", garnish:"Lime spiral ring", note:"J. 'Popo' Galsini, 1967 — gin's greatest tiki moment." },
  { name:"Fog Cutter", tier:5, family:"Tiki", spirit:"Rum", spec:["2 oz white rum","1 oz cognac","1/2 oz gin","2 oz lemon juice","1 oz orange juice","1/2 oz orgeat","1/2 oz amontillado sherry float"], method:"Shake, strain over crushed ice, float sherry", glass:"Tall or fog cutter mug", garnish:"Mint", note:"Trader Vic: 'Fog Cutter, hell — after two of these you won't even see the stuff.'" },
  ...
  { name:"Missionary's Downfall", tier:5, family:"Tiki", spirit:"Rum", spec:["1 oz white rum","1/2 oz peach liqueur","1/2 oz lime juice","1 oz pineapple juice","1/2 oz honey syrup","big handful mint"], method:"Blend with crushed ice until slushy", glass:"Coupe or tiki", garnish:"Mint sprig", note:"Donn Beach — the frozen herb garden." },
  { name:"Queen's Park Swizzle", tier:5, family:"Julep & Smash", spirit:"Rum", spec:["2 oz demerara rum","3/4 oz lime juice","3/4 oz demerara syrup","8 mint leaves","4 dashes Angostura on top"], method:"Swizzle in crushed ice until frosted", glass:"Collins", garnish:"Mint + the bitters float", note:"Trinidad, 1920s — Trader Vic called it the most delightful form of anesthesia." },
  { name:"Corn 'n' Oil", tier:5, family:"Old Fashioned", spirit:"Rum", spec:["2 oz Barbados rum","1/2 oz falernum","1/4 oz lime juice","2 dashes Angostura"], method:"Build over crushed ice, stir briefly", glass:"Rocks", garnish:"Lime wedge", note:"Bajan classic — blackstrap float gives the 'oil slick'." },
  ...
  { name:"Beachcomber", tier:5, family:"Sour", spirit:"Rum", spec:["2 oz white rum","3/4 oz lime juice","1/2 oz triple sec","1/4 oz maraschino","1 tsp simple syrup"], method:"Shake, double strain up", glass:"Coupe", garnish:"Lime wheel", note:"Donn Beach's own namesake — essentially a Daiquiri wearing a little curaçao and maraschino." },
  ...
  { name:"Test Pilot", tier:5, family:"Tiki", spirit:"Rum", spec:["1.5 oz dark Jamaican rum","3/4 oz white rum","1/2 oz lime juice","1/2 oz Cointreau","1/2 oz falernum","1 dash Angostura","6 drops absinthe"], method:"Whip shake, crushed ice", glass:"Double rocks", garnish:"Cherry", note:"Donn Beach — ancestor of the Jet Pilot." },
  ...
  { name:"Ancient Mariner", tier:5, family:"Tiki", spirit:"Rum", spec:["1 oz dark Jamaican rum","1 oz demerara rum","3/4 oz lime juice","1/2 oz grapefruit juice","1/2 oz simple syrup","1/4 oz allspice dram"], method:"Shake, pour over crushed ice", glass:"Double rocks", garnish:"Mint + lime", note:"Beachbum Berry's own creation." },
  ...
  { name:"Suffering Bastard", tier:5, family:"Highball", spirit:"Gin", spec:["1 oz gin","1 oz cognac","1/2 oz lime juice","2 dashes Angostura","4 oz ginger beer"], method:"Build over ice, stir", glass:"Double rocks or mug", garnish:"Mint + orange", note:"Joe Scialom, Cairo 1942 — invented as a hangover cure during the war." },
  ...
  { name:"Blue Hawaii", tier:5, family:"Tiki", spirit:"Rum", spec:["1.5 oz white rum","3/4 oz blue curaçao","2 oz pineapple juice","3/4 oz lime juice","1/2 oz simple syrup"], method:"Shake, strain over crushed ice", glass:"Hurricane", garnish:"Pineapple + umbrella", note:"Harry Yee, Hilton Hawaiian Village, 1957." },
  ...
  { name:"Doctor Funk", tier:5, family:"Tiki", spirit:"Rum", spec:["2 oz dark rum","3/4 oz lime juice","1/2 oz grenadine","1/4 oz absinthe","1/2 oz simple syrup","1 oz soda"], method:"Shake, strain over crushed ice", glass:"Tall", garnish:"Lime + mint", note:"Named for Robert Louis Stevenson's actual physician in Samoa." },
  { name:"Cobra's Fang", tier:5, family:"Tiki", spirit:"Rum", spec:["1.5 oz 151 demerara rum","3/4 oz lime juice","1/2 oz orange juice","1/2 oz falernum","1/4 oz grenadine","1 dash Angostura","6 drops absinthe"], method:"Whip shake, crushed ice", glass:"Tiki mug", garnish:"Lime spiral 'fang'", note:"Donn Beach, 1937." },
  ...
  { name:"Nui Nui", tier:5, family:"Tiki", spirit:"Rum", spec:["2 oz gold rum","1/2 oz lime juice","1/2 oz orange juice","1/4 oz cinnamon syrup","1/4 oz vanilla syrup","1/4 oz allspice dram","1 dash Angostura"], method:"Whip shake, crushed ice", glass:"Tall", garnish:"Orange peel spiral", note:"Donn Beach's spice cabinet in a glass." },
  ...
  { name:"Alaska", tier:6, family:"Spirit & Vermouth", spirit:"Gin", spec:["2.25 oz gin","3/4 oz yellow Chartreuse","1 dash orange bitters"], method:"Stir, strain up", glass:"Coupe", garnish:"Lemon twist", note:"Craddock: 'presumably it was first thought of in South Carolina.'" },
  ...
  { name:"Jack Rose", tier:6, family:"Sour", spirit:"Brandy", spec:["2 oz applejack","3/4 oz lemon juice","1/2 oz grenadine"], method:"Shake, double strain up", glass:"Coupe", garnish:"Apple slice or lemon twist", note:"Hemingway drank one in The Sun Also Rises." },
  { name:"Pegu Club", tier:6, family:"Sour", spirit:"Gin", spec:["2 oz gin","3/4 oz orange curaçao","3/4 oz lime juice","1 dash Angostura","1 dash orange bitters"], method:"Shake, double strain up", glass:"Coupe", garnish:"Lime wheel", note:"The gentlemen's club of colonial Rangoon; later Audrey Saunders' NYC bar." },
  ...
  { name:"Blood and Sand", tier:6, family:"Sour", spirit:"Whiskey", spec:["3/4 oz blended scotch","3/4 oz sweet vermouth","3/4 oz cherry Heering","3/4 oz orange juice"], method:"Shake, strain up", glass:"Coupe", garnish:"Orange twist", note:"Named for Valentino's 1922 bullfighter film — the rare scotch equal-parter." },
  ...
  { name:"Japanese Cocktail", tier:6, family:"Old Fashioned", spirit:"Brandy", spec:["2 oz cognac","1/2 oz orgeat","2 dashes Angostura"], method:"Stir, strain up", glass:"Coupe", garnish:"Lemon twist", note:"Jerry Thomas's own 1862 invention — nothing Japanese about it but the occasion." },
  ...
  { name:"Leap Year", tier:6, family:"Spirit & Vermouth", spirit:"Gin", spec:["2 oz gin","1/2 oz Grand Marnier","1/2 oz sweet vermouth","1 tsp lemon juice"], method:"Stir (or quick shake), strain up", glass:"Coupe", garnish:"Lemon twist", note:"Harry Craddock, February 29, 1928 — 'responsible for more proposals than any other cocktail.'" },
  ...
  { name:"El Diablo", tier:7, family:"Highball", spirit:"Tequila", spec:["1.5 oz blanco tequila","1/2 oz crème de cassis","1/2 oz lime juice","3 oz ginger beer"], method:"Build over ice", glass:"Highball", garnish:"Lime wedge", note:"Trader Vic, 1946 — tequila's devilish buck." },
  ...
  { name:"Batanga", tier:7, family:"Highball", spirit:"Tequila", spec:["2 oz blanco tequila","1/2 oz lime juice","4 oz cola","pinch salt"], method:"Build over ice in salt-rimmed glass, stir with a knife", glass:"Highball, salt rim", garnish:"Lime wedge", note:"Don Javier stirred every one with the same kitchen knife for 60 years at La Capilla." },
  ...
  { name:"Bellini", tier:7, family:"Highball", spirit:"Sparkling wine", spec:["2 oz white peach purée","4 oz prosecco"], method:"Purée first, pour prosecco slowly, gentle lift", glass:"Flute", garnish:"None", note:"Harry's Bar, Venice, 1948 — white peaches only, per Cipriani." },
  { name:"Mimosa", tier:7, family:"Highball", spirit:"Sparkling wine", spec:["2.5 oz orange juice","2.5 oz champagne"], method:"Juice first, bubbles second, no stir", glass:"Flute", garnish:"None", note:"Ritz Paris, 1925. Equal parts — heavier on juice, it's a Buck's Fizz." },
  { name:"Kir Royale", tier:7, family:"Highball", spirit:"Sparkling wine", spec:["1/2 oz crème de cassis","5 oz champagne"], method:"Cassis first, pour bubbles gently", glass:"Flute", garnish:"Lemon twist (optional)", note:"Named for Canon Félix Kir, mayor of Dijon. With still white wine it's simply a Kir." },
  { name:"Death in the Afternoon", tier:7, family:"Highball", spirit:"Absinthe", spec:["1 oz absinthe","4 oz champagne"], method:"Absinthe first, pour champagne until it louches", glass:"Flute", garnish:"None", note:"Hemingway's recipe: 'drink three to five of these slowly.' Do not follow Hemingway's dosage advice." },
  ...
  { name:"Green Tea Shot", tier:7, family:"Sour", spirit:"Whiskey", spec:["1/2 oz Irish whiskey","1/2 oz peach schnapps","1/2 oz lemon juice","1/2 oz simple syrup","splash lemon-lime soda"], method:"Shake, strain into shot glasses", glass:"Shot", garnish:"None", note:"Contains no tea. Named for the color. Bartenders sell hundreds on Saturdays." },
  ...
  { name:"Rusty Nail", tier:8, family:"Duo & Trio", spirit:"Whiskey", spec:["2 oz blended scotch","3/4 oz Drambuie"], method:"Build over ice, stir", glass:"Rocks, large cube", garnish:"Lemon twist", note:"The Rat Pack's favorite screwdriver-free hardware." },
  { name:"Godfather", tier:8, family:"Duo & Trio", spirit:"Whiskey", spec:["2 oz blended scotch","3/4 oz amaretto"], method:"Build over ice, stir", glass:"Rocks", garnish:"None", note:"Marlon Brando-era; swap scotch for vodka and it's a Godmother." },
  ...
  { name:"Tom & Jerry", tier:8, family:"Egg & Cream", spirit:"Rum", spec:["1 oz cognac","1 oz dark rum","2 tbsp Tom & Jerry batter (whipped egg, sugar, spice)","4 oz hot milk"], method:"Batter in mug, spirits, top with hot milk", glass:"Tom & Jerry mug", garnish:"Grated nutmeg", note:"Jerry Thomas claimed it (falsely) — still the king of Wisconsin winters." },
  ...
  { name:"Brandy Old Fashioned", tier:9, family:"Old Fashioned", spirit:"Brandy", spec:["2 oz brandy","1 sugar cube + 2 dashes Angostura","muddled orange slice + cherry","2 oz lemon-lime soda (sweet) or soda water (sour)"], method:"Muddle, build over ice, top", glass:"Rocks", garnish:"Orange + cherry", note:"Wisconsin drinks more brandy per capita than anywhere — 'sweet or sour?' is the state's password." },
  { name:"Pisco Punch", tier:9, family:"Punch", spirit:"Brandy", spec:["2 oz pisco","3/4 oz lemon juice","3/4 oz pineapple gum syrup (or pineapple + rich simple)"], method:"Shake, strain up or over ice", glass:"Coupe or punch cup", garnish:"Pineapple wedge", note:"Gold Rush San Francisco's legend — Duncan Nicol took the true recipe to his grave." },
  ...
  { name:"Mexican Firing Squad", tier:9, family:"Sour", spirit:"Tequila", spec:["2 oz blanco tequila","3/4 oz lime juice","1/2 oz grenadine","4 dashes Angostura"], method:"Shake, strain over ice", glass:"Rocks", garnish:"Lime wheel", note:"Charles Baker found it in a Mexico City bar in 1937." },
  ...
  { name:"Blue Blazer", tier:10, family:"Hot", spirit:"Whiskey", spec:["2 oz cask-strength scotch","2 oz boiling water","1 tsp demerara sugar"], method:"Ignite and throw flaming between two mugs in a long arc", glass:"Pre-heated mug", garnish:"Lemon twist", note:"Jerry Thomas's signature stunt — 'a blazing stream of liquid fire.' Practice with cold water first. Seriously." },
  ...
  { name:"Remember the Maine", tier:10, family:"Spirit & Vermouth", spirit:"Whiskey", spec:["2 oz rye","3/4 oz sweet vermouth","1/4 oz cherry Heering","2 dashes absinthe"], method:"Stir, strain up", glass:"Coupe", garnish:"Brandied cherry", note:"Charles Baker, Havana 1933, 'as the cannons boomed' — stir clockwise, per his instructions." },
  ...
  { name:"Fish House Punch", tier:10, family:"Punch", spirit:"Rum", spec:["1.5 oz Jamaican rum","3/4 oz cognac","1/4 oz peach brandy","3/4 oz lemon juice","3/4 oz simple syrup","1 oz cold water or black tea"], method:"Shake, strain over ice (or scale to the punch bowl it was born in)", glass:"Punch cup or rocks", garnish:"Grated nutmeg + lemon wheel", note:"Philadelphia, 1732 — Washington allegedly lost days to it." },
  ...
  { name:"Stone Fence", tier:10, family:"Highball", spirit:"Brandy", spec:["2 oz applejack (or rye)","4 oz hard cider","2 dashes Angostura"], method:"Build over ice", glass:"Highball", garnish:"Apple slice", note:"Ethan Allen's Green Mountain Boys allegedly drank these before taking Fort Ticonderoga, 1775." },
  ...
  { name:"Bobby Burns", tier:10, family:"Spirit & Vermouth", spirit:"Whiskey", spec:["2 oz blended scotch","1 oz sweet vermouth","1/4 oz Bénédictine"], method:"Stir, strain up", glass:"Coupe", garnish:"Lemon twist", note:"The Rob Roy's bookish brother — Craddock suggested serving it with a recitation of Burns." },
  ...
  { name:"Saratoga", tier:10, family:"Spirit & Vermouth", spirit:"Brandy", spec:["1 oz cognac","1 oz rye","1 oz sweet vermouth","2 dashes Angostura"], method:"Stir, strain up", glass:"Coupe", garnish:"Lemon twist", note:"Jerry Thomas, 1887 — the split-base Manhattan before split bases were cool." },
  ...
  { name:"Knickerbocker", tier:10, family:"Sour", spirit:"Rum", spec:["2 oz aged rum","1/2 oz orange curaçao","1/2 oz lemon juice","1/2 oz raspberry syrup"], method:"Shake, strain over crushed ice", glass:"Rocks", garnish:"Seasonal berries", note:"Jerry Thomas-era — arguably the proto-tiki drink, a century early." },
  { name:"Coffee Cocktail", tier:10, family:"Egg & Cream", spirit:"Fortified wine", spec:["1.5 oz ruby port","1 oz cognac","1 whole egg","1 tsp simple"], method:"Dry shake, shake with ice, strain up", glass:"Small wine glass", garnish:"Grated nutmeg", note:"Contains no coffee — named because it LOOKS like one. Jerry Thomas shrugged about it in print." },
  { name:"Bensonhurst", tier:10, family:"Spirit & Vermouth", spirit:"Whiskey", spec:["2 oz rye","3/4 oz dry vermouth","1/2 oz maraschino","1 tsp Cynar"], method:"Stir, strain up", glass:"Coupe", garnish:"None", note:"Chad Solomon — the dry entry in the Brooklyn-neighborhood series." },
  ...
  { name:"Gin Fizz", tier:2, family:"Egg & Cream", spirit:"Gin", spec:["2 oz gin","3/4 oz lemon juice","3/4 oz simple syrup","1 egg white","2 oz soda water"], method:"Dry shake, shake with ice, strain, top with soda slowly", glass:"Highball, no ice", garnish:"None — the foam is the point", note:"The Silver Fizz. With a yolk it's a Golden Fizz; with both, a Royal. Serve it fast — the foam waits for no one." },

  /* ===== TIER 4 ADDITIONS — modern craft ===== */
  { name:"Gin Gin Mule", tier:4, family:"Highball", spirit:"Gin", spec:["1.75 oz gin","3/4 oz lime juice","3/4 oz simple syrup","1 oz homemade ginger beer","6 mint leaves"], method:"Muddle mint, shake, strain over ice, top", glass:"Highball", garnish:"Mint bouquet + candied ginger", note:"Audrey Saunders, Pegu Club — a Mojito, a Moscow Mule, and a Southside walked into a bar. Arguably the most influential modern gin drink." },
  { name:"Cable Car", tier:4, family:"Sour", spirit:"Rum", spec:["2 oz spiced rum","3/4 oz lemon juice","1/2 oz orange curaçao","1/4 oz simple syrup"], method:"Shake, strain into a cinnamon-sugar rimmed glass", glass:"Coupe, cinnamon-sugar rim", garnish:"Orange twist", note:"Tony Abou-Ganim at the Starlight Room, San Francisco, 1996 — a Sidecar that rode the hill." },
  { name:"Bourbon Renewal", tier:4, family:"Sour", spirit:"Whiskey", spec:["2 oz bourbon","1/2 oz crème de cassis","3/4 oz lemon juice","1/2 oz simple syrup","2 dashes Angostura"], method:"Shake, strain over a large cube", glass:"Rocks", garnish:"Lemon wheel", note:"Jeffrey Morgenthaler — cassis gives a bourbon sour depth and a bruised-plum color." },
  ...
  { name:"Nuclear Daiquiri", tier:4, family:"Sour", spirit:"Rum", spec:["1 oz overproof Jamaican rum","3/4 oz green Chartreuse","1/2 oz falernum","3/4 oz lime juice"], method:"Shake hard, double strain up", glass:"Coupe", garnish:"Lime wheel", note:"Gregor de Gruyther, London — deceptively delicious and genuinely dangerous. One is a treat; two is a decision." },
  ...
  { name:"Clarified Milk Punch", tier:4, family:"Punch", spirit:"Whiskey", spec:["4 oz spirit of choice","2 oz citrus juice","1.5 oz rich syrup","4 oz whole milk (to curdle and filter)"], method:"Add the acidified punch TO the warm milk, rest 1 hour, filter through cloth until crystal clear", glass:"Rocks or coupe", garnish:"Grated nutmeg", note:"An 18th-century technique (Franklin and Dickens both had recipes) revived by modern bars. The milk protein strips harshness and color, leaving something silky and shelf-stable for months." },

  { name:"Cynar Julep", tier:4, family:"Julep & Smash", spirit:"Aperitivo", spec:["2 oz Cynar","1/2 oz lime juice","1/4 oz simple syrup","10 mint leaves"], method:"Lightly press mint, build over crushed ice, swizzle until frosted", glass:"Julep cup or rocks", garnish:"Big mint bouquet", note:"Jim Meehan's PDT creation — a low-proof julep built on artichoke amaro that converts Cynar skeptics on the first sip." },
  { name:"Bitter Mai Tai", tier:4, family:"Tiki", spirit:"Rum", spec:["1.5 oz Campari","3/4 oz Jamaican rum","3/4 oz lime juice","1/2 oz orgeat","1/4 oz orange curaçao"], method:"Whip shake, pour over crushed ice", glass:"Rocks", garnish:"Mint sprig + spent lime shell", note:"Jeremy Oertel, Donna — Campari takes the base spirit's chair and the orgeat keeps it from turning astringent. Contains tree nuts." },
  ...
  { name:"Rosita", tier:9, family:"Spirit & Vermouth", spirit:"Tequila", spec:["1.5 oz reposado tequila","1/2 oz Campari","1/2 oz sweet vermouth","1/2 oz dry vermouth","1 dash Angostura"], method:"Stir over ice", glass:"Rocks", garnish:"Lemon twist", note:"Printed in Mexico's own bar books and rediscovered by Gary Regan — the tequila Negroni that predates the trend by decades." },
  ...
  { name:"Hop Toad", tier:10, family:"Sour", spirit:"Brandy", spec:["1.5 oz apricot brandy","3/4 oz lime juice","1 dash Angostura"], method:"Shake, double strain up", glass:"Coupe", garnish:"Lime wheel", note:"Jerry Thomas-era; two ingredients and better than it deserves to be." },
  { name:"Bishop", tier:10, family:"Punch", spirit:"Wine", spec:["3 oz ruby port","1 oz dark rum","3/4 oz lemon juice","1/2 oz simple syrup"], method:"Shake, pour over crushed ice", glass:"Wine glass or goblet", garnish:"Orange wheel + nutmeg", note:"A 19th-century port punch — the drink Bob Cratchit's family toasts in A Christmas Carol." },

  /* ===== TIER 11 — THE MARTINI BOOK ===== */
  { name:"Vesper", tier:11, family:"Spirit & Vermouth", spirit:"Gin", spec:["3 oz gin","1 oz vodka","1/2 oz Lillet Blanc"], method:"Bond says shake; every bartender says stir. Stir it.", glass:"Coupe or Nick & Nora", garnish:"Large lemon peel, expressed", note:"Ian Fleming wrote it into Casino Royale in 1953 and named it for Vesper Lynd. The original Kina Lillet was more bitter — a dash of quinine or Cocchi Americano gets you closer." },
  ...
  { name:"Dukes Martini", tier:11, family:"Spirit & Vermouth", spirit:"Gin", spec:["3 oz freezer-cold gin","vermouth rinse only","large lemon peel"], method:"Rinse the frozen glass with vermouth, pour gin straight from the freezer, no ice at all", glass:"Frozen Nick & Nora", garnish:"Amalfi lemon peel, expressed hard", note:"Alessandro Palazzi's tableside ritual at Dukes Hotel, London — no dilution whatsoever, which is why they limit guests to two." },
  { name:"Obituary Cocktail", tier:11, family:"Spirit & Vermouth", spirit:"Gin", spec:["2.5 oz gin","1/2 oz dry vermouth","1/4 oz absinthe"], method:"Stir, strain up", glass:"Coupe", garnish:"Lemon twist", note:"Lafitte's Blacksmith Shop, New Orleans — the Martini with a green streak, and the namesake of Kerri McCaffety's great NOLA bar book." },
  ...
  { name:"Breakfast Martini", tier:11, family:"Sour", spirit:"Gin", spec:["2 oz gin","1/2 oz Cointreau","3/4 oz lemon juice","1 heaping barspoon orange marmalade"], method:"Stir the marmalade into the gin first, then shake and double strain", glass:"Coupe", garnish:"Orange twist or a triangle of toast", note:"Salvatore Calabrese, London, 1996 — inspired by his wife insisting he eat breakfast. Dissolve the marmalade fully or it clogs the strainer." },
...
const KNOWLEDGE = [
  { q:"When do you shake a cocktail instead of stirring it?",
    options:["Whenever the guest is watching","When it contains citrus, egg, cream, or juice","Only for drinks served over ice","When it has more than three ingredients"],
    a:1, explain:"Shake anything cloudy (citrus, egg, cream, juice) for aeration and texture. Stir anything all-spirit for silky clarity." },
  { q:"Roughly how much of a properly made cocktail is water from dilution?",
    options:["Almost none","5–10%","20–25%","Half the drink"],
    a:2, explain:"Dilution is 20–25% of the finished drink — it's an ingredient, not a flaw. Jerry Thomas's 1806-era formula literally lists water." },
  { q:"By U.S. law, bourbon must be made from a mash of at least…",
    options:["51% corn","51% rye","80% corn","100% corn"],
    a:0, explain:"At least 51% corn, aged in new charred oak, made in the USA, distilled at no more than 160 proof." },
  { q:"Which bitters define the Sazerac?",
    options:["Angostura","Orange bitters","Peychaud's","Mole bitters"],
    a:2, explain:"Peychaud's — the lighter, anise-cherry bitters born in New Orleans, the Sazerac's hometown." },
  { q:"How should you store vermouth after opening?",
    options:["On the back bar with the spirits","Refrigerated, used within about a month","In the freezer","It doesn't matter — it's fortified"],
    a:1, explain:"Vermouth is wine. It oxidizes. Refrigerate it, date the bottle, and replace it monthly." },
  { q:"What is the purpose of a dry shake?",
    options:["To chill without diluting","To emulsify egg white before adding ice","To warm the tin","To mix carbonated ingredients"],
    a:1, explain:"Shaking without ice first lets the egg protein emulsify fully — then you shake with ice to chill." },
  ...
  { q:"Rhum agricole is distilled from…",
    options:["Molasses","Fresh sugarcane juice","Sugar beet","Sorghum"],
    a:1, explain:"Fresh-pressed cane juice — grassy and vegetal, the French Caribbean style (Martinique)." },
  { q:"Where does mezcal's smoky flavor come from?",
    options:["Peated barley","Charred barrels","Roasting agave in underground pits","Liquid smoke additive"],
    a:2, explain:"Agave hearts are traditionally roasted in earthen pits before fermentation." },
  { q:"Cognac is primarily distilled from which grape?",
    options:["Chardonnay","Ugni Blanc","Riesling","Muscat"],
    a:1, explain:"Ugni Blanc — thin, acidic wine that makes brilliant brandy after double pot distillation." },
  { q:"Who published the first cocktail book, and when?",
    options:["Harry Craddock, 1930","Jerry Thomas, 1862","Dale DeGroff, 2002","Don the Beachcomber, 1934"],
    a:1, explain:"Jerry Thomas's Bar-Tender's Guide (1862) — the founding document of the craft." },
  { q:"The flamed orange peel is the signature move of which bartender?",
    options:["Jim Meehan","Gaz Regan","Dale DeGroff","Sasha Petraske"],
    a:2, explain:"DeGroff made it famous at the Rainbow Room — caramelized orange oil, pure theater." },
  { q:"The 'cocktail families' framework was popularized in The Joy of Mixology by…",
    options:["David Wondrich","Gary 'Gaz' Regan","Jim Meehan","Dale DeGroff"],
    a:1, explain:"Regan's great insight: learn the template and you know a hundred drinks." },
  { q:"Jim Meehan's influential New York bar, opened in 2007, was called…",
    options:["Milk & Honey","Death & Co","PDT","The Rainbow Room"],
    a:2, explain:"PDT — 'Please Don't Tell' — entered through a phone booth in a hot dog shop, and documented in The PDT Cocktail Book." },
  { q:"The first printed definition of 'cocktail' (1806) listed which ingredients?",
    ...
    a:1, explain:"'A stimulating liquor composed of spirits of any kind, sugar, water, and bitters' — the Old Fashioned formula." },
  { q:"Why is a Bloody Mary rolled between tins instead of shaken?",
    options:["It's faster during brunch rush","Shaking aerates and breaks the tomato juice's texture","Rolling chills it more","Tradition only"],
    a:1, explain:"Rolling mixes and chills without whipping air into the tomato — shaking turns it thin and frothy." },
  { q:"Old Tom gin is the historically correct choice for which cocktail?",
    options:["Negroni","Martinez","Aviation","Gimlet"],
    a:1, explain:"The Martinez (and the original Tom Collins) — Old Tom is the lightly sweetened bridge between genever and London Dry." },
  { q:"A typical target pour cost for a well-run cocktail program is…",
    options:["5–10%","18–24%","40–50%","60–70%"],
    a:1, explain:"Pour cost = (cost of goods ÷ selling price) × 100. Most programs target 18–24%." },
  { q:"How do you 'express' a citrus peel?",
    options:["Muddle it in the glass","Snap it skin-side down over the drink to spray the oils","Drop it in whole","Flame it with a lighter"],
    a:1, explain:"Skin-side down, snap to spray oils across the surface, wipe the rim, then drop or discard per spec." },
  { q:"Which two classics call for an absinthe rinse?",
    options:["Manhattan & Martini","Sazerac & Corpse Reviver #2","Negroni & Boulevardier","Daiquiri & Gimlet"],
  ...
  { q:"How should mint be handled for a julep or garnish?",
    options:["Shredded finely for maximum flavor","Slapped or gently pressed to release oils","Frozen first","Muddled to a paste"],
    a:1, explain:"You want the aromatic oils, not the bitter chlorophyll. Slap it, don't shred it." },
  { q:"An Islay single malt scotch is famous for tasting of…",
    ...
    a:1, explain:"Islay's malts are dried over peat fires — that's the Penicillin's smoky float." },
  { q:"Rich simple syrup is what ratio of sugar to water?",
    options:["1:1","2:1","1:2","3:1"],
    a:1, explain:"2:1 sugar to water — sweeter per volume, longer shelf life, and it adds body." },
  { q:"With a standard speed pourer, a steady 4-count is approximately…",
    options:["1/2 oz","1 oz","1.5 oz","2 oz"],
    a:1, explain:"About 1 oz for most pourers — but calibrate YOUR count against a jigger weekly." },
  { q:"Which drink did the Sherry Cobbler help popularize in the 1800s?",
    ...
    a:1, explain:"The Cobbler's mound of crushed ice made the straw a sensation — it also helped make ice itself fashionable." },
  { q:"Ada Coleman, creator of the Hanky Panky, was head bartender at…",
    options:["The Rainbow Room","The Savoy, London","El Floridita, Havana","PDT, New York"],
    a:1, explain:"One of history's great bartenders, running the Savoy's American Bar before Harry Craddock." },
];
...
const STUDY = [
  ...
  { title:"Technique: The Mechanics", rows:[
    ...
    ["Garnish (DeGroff doctrine)","The garnish is the first thing the nose meets — an ingredient, not decoration. Express peels skin-side down; flame orange peels through a match for caramelized oil; slap mint; cut fresh every shift."],
  ]},
  { title:"Syrups, Citrus & Bitters", rows:[
    ...
    ["Bitters","Angostura (clove-cinnamon backbone), Peychaud's (anise-cherry, the Sazerac), orange bitters (the Martini's original secret — Regan's No. 6 is Gaz's own legacy). 2–3 dashes = the pinch of salt in cooking."],
  ]},
  { title:"Hospitality: The Meehan Half", rows:[
  ...
  { title:"History: Know Your Lineage", rows:[
    ...
    ["1862","Jerry Thomas publishes The Bar-Tender's Guide — the first cocktail book, home of the flaming Blue Blazer."],
    ["1870s–1900s","The Golden Age: Manhattan, Martini, Daiquiri are born. Phylloxera devastates cognac; whiskey takes the throne."],
    ["1920–1933","Prohibition scatters American bartenders to Europe and Cuba — Harry Craddock writes The Savoy Cocktail Book (1930)."],
    ["1930s–50s","Tiki era: Don the Beachcomber and Trader Vic."],
    ["1970s–80s","The dark ages of sour mix and neon schnapps."],
    ["1987→","The renaissance: DeGroff revives fresh juice and classic craft at the Rainbow Room; Regan writes the theory (2003); Milk & Honey (2000) sets the modern standard; Meehan's PDT (2007) refines and documents it."],
  ]},
];
